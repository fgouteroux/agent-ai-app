        ...
        const renderDiagram = async () => {
            try {
                ...
                mermaid.initialize({
                    ...
                    // 'loose' skips Mermaid's own DOMPurify pass entirely (our
                    // dompurifyConfig below would be silently ignored), and the
                    // diagram source here is untrusted model output -- a
                    // `click A "javascript:..."` directive would execute on
                    // click. 'antiscript' still runs everything through
                    // DOMPurify (so the html/foreignObject profile below keeps
                    // working for multi-line labels) but strips script/click-js.
